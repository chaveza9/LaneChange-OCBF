    ...
    methods
        function self = IntelligentVehicle(VehID, VehicleScenario, ...
            ...
            arguments
                ...
                Options.AdaptiveSafety logical {mustBeNumericOrLogical} =  true;
            ...
            self.AdaptiveSafetyCheck = Options.AdaptiveSafety;
            ...
            self.Dynamics = Dynamics.VehicleDynamics(initStates,...
                ...
                'VelMin', self.VelMin,...
                'w_x', self.w_x*Options.Noise,...
                'w_y', self.w_y*Options.Noise,...
